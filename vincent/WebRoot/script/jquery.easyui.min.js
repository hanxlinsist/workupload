...
$.fn.combobox=function(_9ea,_9eb){
if(typeof _9ea=="string"){
var _9ec=$.fn.combobox.methods[_9ea];
if(_9ec){
return _9ec(this,_9eb);
}else{
return this.combo(_9ea,_9eb);
}
}
_9ea=_9ea||{};
return this.each(function(){
var _9ed=$.data(this,"combobox");
if(_9ed){
$.extend(_9ed.options,_9ea);
}else{
_9ed=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_9ea),data:[]});
}
_9e6(this);
if(_9ed.options.data){
_9d3(this,_9ed.options.data);
}else{
...
var _9ee=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{width:_9ee.width,height:_9ee.height,originalValue:_9ee.originalValue,disabled:_9ee.disabled,readonly:_9ee.readonly});
},getData:function(jq){
...
return jq.each(function(){
$(this).combo("clear");
var _9f1=$(this).combo("panel");
_9f1.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
},select:function(jq,_9f2){
return jq.each(function(){
_9c3(this,_9f2);
});
},unselect:function(jq,_9f3){
return jq.each(function(){
_9c9(this,_9f3);
});
}};
$.fn.combobox.parseOptions=function(_9f4){
var t=$(_9f4);
return $.extend({},$.fn.combo.parseOptions(_9f4),$.parser.parseOptions(_9f4,["valueField","textField","groupField","mode","method","url",{showItemIcon:"boolean"}]));
};
$.fn.combobox.parseData=function(_9f5){
var data=[];
var opts=$(_9f5).combobox("options");
$(_9f5).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _9f6=$(this).attr("label");
...
row[opts.groupField]=_9f8;
}
data.push(row);
};
};
var _9f9=0;
var _9fa={render:function(_9fb,_9fc,data){
var _9fd=$.data(_9fb,"combobox");
var opts=_9fd.options;
_9f9++;
_9fd.itemIdPrefix="_easyui_combobox_i"+_9f9;
_9fd.groupIdPrefix="_easyui_combobox_g"+_9f9;
_9fd.groups=[];
var dd=[];
var _9fe=undefined;
for(var i=0;i<data.length;i++){
...
_9fe=g;
_9fd.groups.push(g);
dd.push("<div id=\""+(_9fd.groupIdPrefix+"_"+(_9fd.groups.length-1))+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_9fb,g):g);
dd.push("</div>");
}
}else{
_9fe=undefined;
...
dd.push("<div id=\""+(_9fd.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
if(opts.showItemIcon&&row.iconCls){
dd.push("<span class=\"combobox-icon "+row.iconCls+"\"></span>");
}
dd.push(opts.formatter?opts.formatter.call(_9fb,row):s);
dd.push("</div>");
}
$(_9fc).html(dd.join(""));
}};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,groupFormatter:function(_9ff){
return _9ff;
},mode:"local",method:"post",url:null,data:null,queryParams:{},showItemIcon:false,view:_9fa,keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
},loader:function(_a00,_a01,_a02){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_a00,dataType:"json",success:function(data){
_a01(data);
},error:function(){
_a02.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},finder:{getEl:function(_a03,_a04){
var _a05=_9b7(_a03,_a04);
var id=$.data(_a03,"combobox").itemIdPrefix+"_"+_a05;
return $("#"+id);
},getGroupEl:function(_a06,_a07){
var _a08=$.data(_a06,"combobox");
var _a09=$.easyui.indexOfArray(_a08.groups,_a07);
var id=_a08.groupIdPrefix+"_"+_a09;
return $("#"+id);
},getRow:function(_a0a,p){
var _a0b=$.data(_a0a,"combobox");
var _a0c=(p instanceof jQuery)?p.attr("id").substr(_a0b.itemIdPrefix.length+1):_9b7(_a0a,p);
return _a0b.data[parseInt(_a0c)];
}},onBeforeLoad:function(_a0d){
},onLoadSuccess:function(){
},onLoadError:function(){
},onSelect:function(_a0e){
},onUnselect:function(_a0f){
}});
})(jQuery);
(function($){
function _a10(_a11){
var _a12=$.data(_a11,"combotree");
var opts=_a12.options;
var tree=_a12.tree;
$(_a11).addClass("combotree-f");
$(_a11).combo(opts);
var _a13=$(_a11).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_a13);
$.data(_a11,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _a14=$(_a11).combotree("getValues");
if(opts.multiple){
var _a15=tree.tree("getChecked");
...
$(_a11).combo("hidePanel");
}
_a17(_a11);
opts.onClick.call(this,node);
},onCheck:function(node,_a16){
_a17(_a11);
opts.onCheck.call(this,node,_a16);
}}));
};
function _a17(_a18){
var _a19=$.data(_a18,"combotree");
var opts=_a19.options;
var tree=_a19.tree;
var vv=[],ss=[];
if(opts.multiple){
var _a1a=tree.tree("getChecked");
...
$(_a18).combo("setText",ss.join(opts.separator)).combo("setValues",opts.multiple?vv:(vv.length?vv:[""]));
};
function _a1b(_a1c,_a1d){
var _a1e=$.data(_a1c,"combotree");
var opts=_a1e.options;
var tree=_a1e.tree;
var _a1f=tree.tree("options");
var _a20=_a1f.onCheck;
var _a21=_a1f.onSelect;
_a1f.onCheck=_a1f.onSelect=function(){
};
tree.find("span.tree-checkbox").addClass("tree-checkbox0").removeClass("tree-checkbox1 tree-checkbox2");
if(!$.isArray(_a1d)){
_a1d=_a1d.split(opts.separator);
}
var vv=$.map(_a1d,function(_a22){
return String(_a22);
});
var ss=[];
$.map(vv,function(v){
...
ss.push(_a23(v,opts.mappingRows)||v);
}
});
if(opts.multiple){
var _a24=tree.tree("getChecked");
$.map(_a24,function(node){
...
_a1f.onCheck=_a20;
_a1f.onSelect=_a21;
$(_a1c).combo("setText",ss.join(opts.separator)).combo("setValues",opts.multiple?vv:(vv.length?vv:[""]));
function _a23(_a25,a){
for(var i=0;i<a.length;i++){
if(_a25==a[i].id){
return a[i].text;
}
...
$.fn.combotree=function(_a26,_a27){
if(typeof _a26=="string"){
var _a28=$.fn.combotree.methods[_a26];
if(_a28){
return _a28(this,_a27);
}else{
return this.combo(_a26,_a27);
}
}
_a26=_a26||{};
return this.each(function(){
var _a29=$.data(this,"combotree");
if(_a29){
$.extend(_a29.options,_a26);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_a26)});
}
_a10(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _a2a=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_a2a.width,height:_a2a.height,originalValue:_a2a.originalValue,disabled:_a2a.disabled,readonly:_a2a.readonly});
},clone:function(jq,_a2b){
var t=jq.combo("clone",_a2b);
...
if($.isArray(_a2c)){
_a2c=$.map(_a2c,function(_a2d){
if(typeof _a2d=="object"){
var id=_a2d.id;
var text=_a2d.text;
(function(){
for(var i=0;i<opts.mappingRows.length;i++){
if(id==opts.mappingRows[i].id){
opts.mappingRows[i]=_a2d;
return;
}
}
opts.mappingRows.push(_a2d);
})();
return id;
}else{
return _a2d;
...
$.fn.combotree.parseOptions=function(_a2f){
return $.extend({},$.fn.combo.parseOptions(_a2f),$.fn.tree.parseOptions(_a2f));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false,mappingRows:[]});
})(jQuery);
(function($){
function _a30(_a31){
var _a32=$.data(_a31,"combogrid");
var opts=_a32.options;
var grid=_a32.grid;
$(_a31).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combogrid("panel");
var _a33=p.outerHeight()-p.height();
var _a34=p._size("minHeight");
var _a35=p._size("maxHeight");
var dg=$(this).combogrid("grid");
dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_a34?_a34-_a33:""),maxHeight:(_a35?_a35-_a33:"")});
...
var _a36=$(_a31).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_a36);
_a32.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _a37=$(_a31).combo("getValues");
var _a38=opts.onSelect;
opts.onSelect=function(){
};
_a3e(_a31,_a37,_a32.remainText);
opts.onSelect=_a38;
opts.onLoadSuccess.apply(_a31,arguments);
},onClickRow:_a39,onSelect:function(_a3a,row){
_a3b();
opts.onSelect.call(this,_a3a,row);
},onUnselect:function(_a3c,row){
_a3b();
opts.onUnselect.call(this,_a3c,row);
},onSelectAll:function(rows){
_a3b();
...
function _a39(_a3d,row){
_a32.remainText=false;
_a3b();
if(!opts.multiple){
$(_a31).combo("hidePanel");
}
opts.onClickRow.call(this,_a3d,row);
};
function _a3b(){
...
_a3e(_a31,vv,_a32.remainText);
};
};
function nav(_a3f,dir){
var _a40=$.data(_a3f,"combogrid");
var opts=_a40.options;
var grid=_a40.grid;
var _a41=grid.datagrid("getRows").length;
if(!_a41){
return;
}
...
var _a42;
if(!tr.length){
_a42=(dir=="next"?0:_a41-1);
}else{
var _a42=parseInt(tr.attr("datagrid-row-index"));
_a42+=(dir=="next"?1:-1);
if(_a42<0){
_a42=_a41-1;
}
...
grid.datagrid("highlightRow",_a42);
if(opts.selectOnNavigation){
_a40.remainText=false;
grid.datagrid("selectRow",_a42);
}
};
function _a3e(_a43,_a44,_a45){
var _a46=$.data(_a43,"combogrid");
var opts=_a46.options;
var grid=_a46.grid;
var _a47=$(_a43).combo("getValues");
var _a48=$(_a43).combo("options");
var _a49=_a48.onChange;
_a48.onChange=function(){
};
var _a4a=grid.datagrid("options");
var _a4b=_a4a.onSelect;
var _a4c=_a4a.onUnselectAll;
_a4a.onSelect=_a4a.onUnselectAll=function(){
};
if(!$.isArray(_a44)){
_a44=_a44.split(opts.separator);
}
var _a4d=$.map(_a44,function(v){
return String(v);
});
var _a4e=[];
$.map(grid.datagrid("getSelections"),function(row){
if($.inArray(String(row[opts.idField]),_a4d)>=0){
_a4e.push(row);
}
});
grid.datagrid("clearSelections");
grid.data("datagrid").selectedRows=_a4e;
var ss=[];
for(var i=0;i<_a44.length;i++){
var _a4f=_a44[i];
var _a50=grid.datagrid("getRowIndex",_a4f);
if(_a50>=0){
grid.datagrid("selectRow",_a50);
}
ss.push(_a51(_a4f,grid.datagrid("getRows"))||_a51(_a4f,grid.datagrid("getSelections"))||_a51(_a4f,opts.mappingRows)||_a4f);
}
opts.unselectedValues=[];
var _a52=$.map(_a4e,function(row){
return String(row[opts.idField]);
});
$.map(_a44,function(_a53){
if($.inArray(String(_a53),_a52)==-1){
opts.unselectedValues.push(_a53);
}
});
$(_a43).combo("setValues",_a47);
_a48.onChange=_a49;
_a4a.onSelect=_a4b;
_a4a.onUnselectAll=_a4c;
if(!_a45){
var s=ss.join(opts.separator);
if($(_a43).combo("getText")!=s){
$(_a43).combo("setText",s);
}
}
$(_a43).combo("setValues",_a44);
function _a51(_a54,a){
for(var i=0;i<a.length;i++){
if(_a54==a[i][opts.idField]){
...
function _a58(_a59){
var _a5a=$.data(_a59,"combogrid");
var opts=_a5a.options;
var grid=_a5a.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_a5a.remainText=false;
if(tr.length){
var _a5b=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_a5b);
}else{
grid.datagrid("selectRow",_a5b);
}
}else{
grid.datagrid("selectRow",_a5b);
}
...
$(_a59).combogrid("setValues",vv);
if(!opts.multiple){
$(_a59).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_a5c,_a5d){
if(typeof _a5c=="string"){
var _a5e=$.fn.combogrid.methods[_a5c];
if(_a5e){
return _a5e(this,_a5d);
}else{
return this.combo(_a5c,_a5d);
}
}
_a5c=_a5c||{};
return this.each(function(){
var _a5f=$.data(this,"combogrid");
if(_a5f){
$.extend(_a5f.options,_a5c);
}else{
_a5f=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_a5c)});
}
_a30(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _a60=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{width:_a60.width,height:_a60.height,originalValue:_a60.originalValue,disabled:_a60.disabled,readonly:_a60.readonly});
},grid:function(jq){
return $.data(jq[0],"combogrid").grid;
},setValues:function(jq,_a61){
return jq.each(function(){
var opts=$(this).combogrid("options");
if($.isArray(_a61)){
_a61=$.map(_a61,function(_a62){
if(typeof _a62=="object"){
var v=_a62[opts.idField];
(function(){
for(var i=0;i<opts.mappingRows.length;i++){
if(v==opts.mappingRows[i][opts.idField]){
opts.mappingRows[i]=_a62;
return;
}
}
opts.mappingRows.push(_a62);
})();
return v;
}else{
return _a62;
...
},setValue:function(jq,_a63){
return jq.each(function(){
$(this).combogrid("setValues",[_a63]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combogrid.parseOptions=function(_a64){
var t=$(_a64);
return $.extend({},$.fn.combo.parseOptions(_a64),$.fn.datagrid.parseOptions(_a64),$.parser.parseOptions(_a64,["idField","textField","mode"]));
};
...
(function($){
function _a65(_a66){
var _a67=$.data(_a66,"datebox");
var opts=_a67.options;
$(_a66).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_a68(this);
_a69(this);
_a6a(this);
_a78(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_a67.calendar){
var _a6b=$(_a66).combo("panel").css("overflow","hidden");
_a6b.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_a6b);
...
_a67.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_a67.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _a6c=this.target;
var opts=$(_a6c).datebox("options");
_a78(_a6c,opts.formatter.call(_a6c,date));
$(_a6c).combo("hidePanel");
opts.onSelect.call(_a6c,date);
}});
}
$(_a66).combo("textbox").parent().addClass("datebox");
$(_a66).datebox("initValue",opts.value);
function _a68(_a6d){
var opts=$(_a6d).datebox("options");
var _a6e=$(_a6d).combo("panel");
_a6e.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _a6f=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_a6f].handler.call(e.target,_a6d);
}
});
};
function _a69(_a70){
var _a71=$(_a70).combo("panel");
if(_a71.children("div.datebox-button").length){
return;
}
var _a72=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_a71);
var tr=_a72.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text)?btn.text(_a70):btn.text).appendTo(td);
...
var cc=_a74.children("div.datebox-calendar-inner");
_a74.children()._outerWidth(_a74.width());
_a67.calendar.appendTo(cc);
_a67.calendar[0].target=_a73;
if(opts.panelHeight!="auto"){
var _a75=_a74.height();
_a74.children().not(cc).each(function(){
_a75-=$(this).outerHeight();
});
cc._outerHeight(_a75);
}
_a67.calendar.calendar("resize");
};
};
...
function _a79(_a7a){
var _a7b=$.data(_a7a,"datebox");
var opts=_a7b.options;
var _a7c=_a7b.calendar.calendar("options").current;
if(_a7c){
_a78(_a7a,opts.formatter.call(_a7a,_a7c));
$(_a7a).combo("hidePanel");
}
};
function _a78(_a7d,_a7e,_a7f){
var _a80=$.data(_a7d,"datebox");
var opts=_a80.options;
var _a81=_a80.calendar;
_a81.calendar("moveTo",opts.parser.call(_a7d,_a7e));
if(_a7f){
$(_a7d).combo("setValue",_a7e);
}else{
if(_a7e){
_a7e=opts.formatter.call(_a7d,_a81.calendar("options").current);
}
$(_a7d).combo("setText",_a7e).combo("setValue",_a7e);
}
};
$.fn.datebox=function(_a82,_a83){
if(typeof _a82=="string"){
var _a84=$.fn.datebox.methods[_a82];
if(_a84){
return _a84(this,_a83);
}else{
return this.combo(_a82,_a83);
}
}
_a82=_a82||{};
return this.each(function(){
var _a85=$.data(this,"datebox");
if(_a85){
$.extend(_a85.options,_a82);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_a82)});
}
_a65(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _a86=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{width:_a86.width,height:_a86.height,originalValue:_a86.originalValue,disabled:_a86.disabled,readonly:_a86.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_a87){
return jq.each(function(){
var opts=$(this).datebox("options");
var _a88=opts.value;
if(_a88){
_a88=opts.formatter.call(this,opts.parser.call(this,_a88));
}
$(this).combo("initValue",_a88).combo("setText",_a88);
});
},setValue:function(jq,_a89){
return jq.each(function(){
_a78(this,_a89);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_a8a){
return $.extend({},$.fn.combo.parseOptions(_a8a),$.parser.parseOptions(_a8a,["sharedCalendar"]));
};
...
_a76(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_a8b){
return $(_a8b).datebox("options").currentText;
},handler:function(_a8c){
var now=new Date();
$(_a8c).datebox("calendar").calendar({year:now.getFullYear(),month:now.getMonth()+1,current:new Date(now.getFullYear(),now.getMonth(),now.getDate())});
_a79(_a8c);
}},{text:function(_a8d){
return $(_a8d).datebox("options").closeText;
},handler:function(_a8e){
...
(function($){
function _a8f(_a90){
var _a91=$.data(_a90,"datetimebox");
var opts=_a91.options;
$(_a90).datebox($.extend({},opts,{onShowPanel:function(){
var _a92=$(this).datetimebox("getValue");
_a98(this,_a92,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_a90).removeClass("datebox-f").addClass("datetimebox-f");
$(_a90).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_a91.spinner){
var _a93=$(_a90).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_a93.children("div.datebox-calendar-inner"));
_a91.spinner=p.children("input");
}
_a91.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_a90).datetimebox("initValue",opts.value);
};
function _a94(_a95){
var c=$(_a95).datetimebox("calendar");
var t=$(_a95).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _a96(_a97,q){
_a98(_a97,q,true);
};
function _a99(_a9a){
var opts=$.data(_a9a,"datetimebox").options;
var date=_a94(_a9a);
_a98(_a9a,opts.formatter.call(_a9a,date));
$(_a9a).combo("hidePanel");
};
function _a98(_a9b,_a9c,_a9d){
var opts=$.data(_a9b,"datetimebox").options;
$(_a9b).combo("setValue",_a9c);
if(!_a9d){
if(_a9c){
var date=opts.parser.call(_a9b,_a9c);
$(_a9b).combo("setText",opts.formatter.call(_a9b,date));
$(_a9b).combo("setValue",opts.formatter.call(_a9b,date));
}else{
$(_a9b).combo("setText",_a9c);
}
}
var date=opts.parser.call(_a9b,_a9c);
$(_a9b).datetimebox("calendar").calendar("moveTo",date);
$(_a9b).datetimebox("spinner").timespinner("setValue",_a9e(date));
function _a9e(date){
function _a9f(_aa0){
return (_aa0<10?"0":"")+_aa0;
};
var tt=[_a9f(date.getHours()),_a9f(date.getMinutes())];
if(opts.showSeconds){
tt.push(_a9f(date.getSeconds()));
}
return tt.join($(_a9b).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_aa1,_aa2){
if(typeof _aa1=="string"){
var _aa3=$.fn.datetimebox.methods[_aa1];
if(_aa3){
return _aa3(this,_aa2);
}else{
return this.datebox(_aa1,_aa2);
}
}
_aa1=_aa1||{};
return this.each(function(){
var _aa4=$.data(this,"datetimebox");
if(_aa4){
$.extend(_aa4.options,_aa1);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_aa1)});
}
_a8f(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _aa5=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_aa5.originalValue,disabled:_aa5.disabled,readonly:_aa5.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_aa6){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _aa7=opts.value;
if(_aa7){
_aa7=opts.formatter.call(this,opts.parser.call(this,_aa7));
}
$(this).combo("initValue",_aa7).combo("setText",_aa7);
});
},setValue:function(jq,_aa8){
return jq.each(function(){
_a98(this,_aa8);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_aa9){
var t=$(_aa9);
return $.extend({},$.fn.datebox.parseOptions(_aa9),$.parser.parseOptions(_aa9,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_a96(this,q);
}},buttons:[{text:function(_aaa){
return $(_aaa).datetimebox("options").currentText;
},handler:function(_aab){
var opts=$(_aab).datetimebox("options");
_a98(_aab,opts.formatter.call(_aab,new Date()));
$(_aab).datetimebox("hidePanel");
}},{text:function(_aac){
return $(_aac).datetimebox("options").okText;
},handler:function(_aad){
_a99(_aad);
}},{text:function(_aae){
return $(_aae).datetimebox("options").closeText;
},handler:function(_aaf){
$(_aaf).datetimebox("hidePanel");
}}],formatter:function(date){
var h=date.getHours();
var M=date.getMinutes();
var s=date.getSeconds();
function _ab0(_ab1){
return (_ab1<10?"0":"")+_ab1;
};
var _ab2=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_ab0(h)+_ab2+_ab0(M);
...
var _ab3=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_ab3);
var hour=parseInt(tt[0],10)||0;
var _ab4=parseInt(tt[1],10)||0;
var _ab5=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_ab4,_ab5);
}});
})(jQuery);
(function($){
function init(_ab6){
var _ab7=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_ab6);
var t=$(_ab6);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_ab7.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_ab7.bind("_resize",function(e,_ab8){
if($(this).hasClass("easyui-fluid")||_ab8){
_ab9(_ab6);
}
return false;
});
...
var _abc=$.data(_aba,"slider");
var opts=_abc.options;
var _abd=_abc.slider;
if(_abb){
if(_abb.width){
opts.width=_abb.width;
}
if(_abb.height){
opts.height=_abb.height;
}
}
_abd._size(opts);
if(opts.mode=="h"){
_abd.css("height","");
_abd.children("div").css("height","");
}else{
_abd.css("width","");
_abd.children("div").css("width","");
_abd.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_abd._outerHeight());
}
_abe(_aba);
};
function _abf(_ac0){
var _ac1=$.data(_ac0,"slider");
var opts=_ac1.options;
var _ac2=_ac1.slider;
...
_ac3(aa);
function _ac3(aa){
var rule=_ac2.find("div.slider-rule");
var _ac4=_ac2.find("div.slider-rulelabel");
rule.empty();
_ac4.empty();
for(var i=0;i<aa.length;i++){
var _ac5=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_ac5);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_ac4);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_ac5,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_ac5,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _ac6(_ac7){
var _ac8=$.data(_ac7,"slider");
var opts=_ac8.options;
var _ac9=_ac8.slider;
_ac9.removeClass("slider-h slider-v slider-disabled");
_ac9.addClass(opts.mode=="h"?"slider-h":"slider-v");
_ac9.addClass(opts.disabled?"slider-disabled":"");
var _aca=_ac9.find(".slider-inner");
_aca.html("<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_aca.append("<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_ac9.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_ac8.isDragging=true;
opts.onSlideStart.call(_ac7,opts.value);
},onStopDrag:function(e){
_acc(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_ac7,opts.value);
opts.onComplete.call(_ac7,opts.value);
_ac8.isDragging=false;
}});
_ac9.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_ac8.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_acc(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_ac7,opts.value);
});
function _acc(pos,_acd){
var _ace=_acf(_ac7,pos);
var s=Math.abs(_ace%opts.step);
if(s<opts.step/2){
_ace-=s;
}else{
_ace=_ace-s+opts.step;
}
if(opts.range){
var v1=opts.value[0];
var v2=opts.value[1];
...
if(_acd){
var _ad0=$(_acd).nextAll(".slider-handle").length>0;
if(_ace<=v2&&_ad0){
v1=_ace;
}else{
if(_ace>=v1&&(!_ad0)){
...
_ace<m?v1=_ace:v2=_ace;
}
}
}
$(_ac7).slider("setValues",[v1,v2]);
}else{
$(_ac7).slider("setValue",_ace);
}
};
};
function _ad1(_ad2,_ad3){
var _ad4=$.data(_ad2,"slider");
var opts=_ad4.options;
var _ad5=_ad4.slider;
var _ad6=$.isArray(opts.value)?opts.value:[opts.value];
var _ad7=[];
if(!$.isArray(_ad3)){
_ad3=$.map(String(_ad3).split(opts.separator),function(v){
return parseFloat(v);
});
}
_ad5.find(".slider-value").remove();
var name=$(_ad2).attr("sliderName")||"";
...
var _ad9=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_ad5);
_ad9.attr("name",name);
_ad9.val(_ad8);
_ad7.push(_ad8);
var _ada=_ad5.find(".slider-handle:eq("+i+")");
var tip=_ada.next();
var pos=_adb(_ad2,_ad8);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_ad2,_ad8));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _adc="left:"+pos+"px;";
_ada.attr("style",_adc);
tip.attr("style",_adc+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _adc="top:"+pos+"px;";
_ada.attr("style",_adc);
tip.attr("style",_adc+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_ad7:_ad7[0];
$(_ad2).val(opts.range?_ad7.join(opts.separator):_ad7[0]);
if(_ad6.join(",")!=_ad7.join(",")){
opts.onChange.call(_ad2,opts.value,(opts.range?_ad6:_ad6[0]));
}
};
function _abe(_add){
var opts=$.data(_add,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_ad1(_add,opts.value);
opts.onChange=fn;
};
function _adb(_ade,_adf){
var _ae0=$.data(_ade,"slider");
var opts=_ae0.options;
var _ae1=_ae0.slider;
var size=opts.mode=="h"?_ae1.width():_ae1.height();
var pos=opts.converter.toPosition.call(_ade,_adf,size);
if(opts.mode=="v"){
pos=_ae1.height()-pos;
}
if(opts.reversed){
...
function _acf(_ae2,pos){
var _ae3=$.data(_ae2,"slider");
var opts=_ae3.options;
var _ae4=_ae3.slider;
var size=opts.mode=="h"?_ae4.width():_ae4.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _ae5=opts.converter.toValue.call(_ae2,pos,size);
return _ae5.toFixed(0);
};
$.fn.slider=function(_ae6,_ae7){
if(typeof _ae6=="string"){
return $.fn.slider.methods[_ae6](this,_ae7);
}
_ae6=_ae6||{};
return this.each(function(){
var _ae8=$.data(this,"slider");
if(_ae8){
$.extend(_ae8.options,_ae6);
}else{
_ae8=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_ae6),slider:init(this)});
$(this).removeAttr("disabled");
}
...
_ad1(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_aec){
var t=$(_aec);
return $.extend({},$.parser.parseOptions(_aec,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_aed){
return _aed;
},converter:{toPosition:function(_aee,size){
var opts=$(this).slider("options");
return (_aee-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_aef,_af0){
},onSlideStart:function(_af1){
},onSlideEnd:function(_af2){
},onComplete:function(_af3){
}};
})(jQuery);
